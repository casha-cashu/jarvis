...
class MiscSoundNotificationsConfig(BaseModel):
    enabled: bool = False
    wake_sound: Optional[str] = None
    command_sound: Optional[str] = None


class MiscGUIConfig(BaseModel):
    enabled: bool = False
    launcher: str = "rofi"
...
class MiscConfig(BaseModel):
    ...
    cleanup_temp_on_start: bool = True
    sound_notifications: MiscSoundNotificationsConfig = Field(default_factory=MiscSoundNotificationsConfig)
    gui: MiscGUIConfig = Field(default_factory=MiscGUIConfig)
...
class JarvisConfig(BaseModel):
    ...
    hyprland: dict = Field(default_factory=dict)
